...
export function ValueProposition() {
  return (
    <section aria-labelledby="value-title" className="py-24">
      <div className="container px-4 md:px-6">
        <h2 id="value-title" className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl text-center mb-12 font-headline">
          Una propuesta de valor diferencial
        </h2>
        <BentoGrid className="lg:grid-cols-2">
          {features.map(({ Icon, name, description, className }) => (
            <BentoCard key={name} className={className}>
              <BentoCardContent>
                <BentoCardHeader>
